...
function Newsletter() {
  return (
    <form
      action="https://app.convertkit.com/forms/3885288/subscriptions" method="post"
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Vijay Tupakula - Software Engineer, founder and Tinkerer
        </title>
        <meta
          name="description"
          content="I’m Vijay Tupakula. Software Engineer, Founder and a Tinkerer of many things. Building Future Smart Homes"
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <Link className="px-2 mt-2 py-6 bg-green-500 rounded text-white w-full w-100 block text-center" target="_blank" href="https://tidycal.com/vijaytupakula">1-1 Consultation for your Smart Home 🏡</Link>
